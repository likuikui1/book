 ...
 *
 */
public class BookMarketGridViewAdapter extends BaseAdapter{
	private Context mcontext;
	public String[] name={"书籍分类:","全部分类","考试类","英语","文学/小说","IT/工业","经济/管理","其他","适合人群:","不限","教材资料","课外","出售类别:","不限","出售","出借"};
		public BookMarketGridViewAdapter( Context mcontext) {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
	     ...
	     ViewHolder mHolder;
			...
			if (position==0) {
				...
				mHolder.bookstype_gv_btn.setBackground(null);
