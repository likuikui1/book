...
public class NewBookGroudingViewPagerFragmentAdapter extends BaseAdapter {
	private List<Map<String, Object>> data;
	private Context mContext;

	public NewBookGroudingViewPagerFragmentAdapter(Context mContext,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			// 根据自定义的Item布局加载布局
			convertView = LayoutInflater.from(mContext).inflate(R.layout.newbook_listview_item, null);
		...
		holder.newbook_item_bookname.setText((String) data.get(position).get(
				"newbook_item_bookname"));
		...
		holder.newbook_listview_price.setText((String) data.get(position).get(
				"newbook_listview_price"));
