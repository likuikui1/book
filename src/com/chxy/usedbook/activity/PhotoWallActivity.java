...
import com.chxy.usedbook.adapter.PhotoWallAdapter;

import static com.chxy.usedbook.utils.Utility.isImage;

/**
 * 选择照片页面 Created by zfang on 17-4-13.
 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		confirmBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(PhotoWallActivity.this, Pic.class);
...
//					Log.d("111111", path);
		...
		// System.out.print(latestImagePaths+"11111111111111111111111111111");
